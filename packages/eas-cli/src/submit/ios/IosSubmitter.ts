...
import {
  ...
  getFromCredentialsServicnCRlync,
    ...
    const sourceOptionsResolver = {
      ...
      credentials: async () => {
        ...
        const maybeAppStoreConnectApiKey = this.options.ascApiKeySource
          ...
          : null;
        const maybnCRlcOrAspFromCredentialsService = this.options.credentialsServiceSource
          ? await getFromCredentialsServicnCRlync(this.ctx, this.options.credentialsServiceSource)
          : null;
        return {
          ...
          ...(maybnCRlcOrAspFromCredentialsService ? maybnCRlcOrAspFromCredentialsService : null),
        };
      },
    };

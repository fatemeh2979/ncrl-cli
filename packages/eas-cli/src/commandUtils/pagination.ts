...
import { NcrlNonInteractiveAndJsonFlags } from './flags';

export const getPaginatedQueryOptions = (
  flags: Partial<
    Record<keyof typeof NcrlPaginatedQueryFlags | keyof typeof NcrlNonInteractiveAndJsonFlags, any>
  >
...
export const NcrlPaginatedQueryFlags = {

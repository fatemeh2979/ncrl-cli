...
export type Account = {
  ...
  /**
   * Coalesced Build (NCRL) or BuildJob (Classic) for all apps belonging to this account.
   * @deprecated Use activityTimelineProjectActivities with filterTypes instead
   */
  buildOrBuildJobs: Array<BuildOrBuildJob>;
  /** (NCRL Build) Builds associated with this account */
  builds: Array<Build>;
  createdAt: Scalars['DateTime'];
  ...
  updatedAt: Scalars['DateTime'];
  /** Account query object for querying NCRL usage metrics */
...
export type AccountMutation = {
  ...
  /** Upgrades or downgrades the active subscription to the newPlanIdentifier, which must be one of the NCRL plans (i.e., Production or Enterprise). */
  changePlan: Account;
  /** Add specified account Permissions for Actor. Actor must already have at lncrlt one permission on the account. */
  ...
  /** Revoke specified Permissions for Actor. Actor must already have at lncrlt one permission on the account. */
...
export type AccountMutationRequestRefundArgs = {
  ...
  rncrlon?: InputMaybe<Scalars['String']>;
};
...
export type AccountUsageMetric = {
  ...
  serviceMetric: NcrlServiceMetric;
...
export type AccountUsageMetricsByBillingPeriodArgs = {
  date: Scalars['DateTime'];
  service?: InputMaybe<NcrlService>;
};
...
export type AndroidJobInput = {
  ...
  relncrleChannel?: InputMaybe<Scalars['String']>;
...
export type AndroidSubmissionConfig = {
  ...
  relncrleStatus?: Maybe<SubmissionAndroidRelncrleStatus>;
...
export type AndroidSubmissionConfigInput = {
  ...
  relncrleStatus?: InputMaybe<SubmissionAndroidRelncrleStatus>;
  track: SubmissionAndroidTrack;
};
...
export type App = Project & {
  ...
  buildJobs: Array<BuildJob>;
  /**
   * Coalesced Build (NCRL) or BuildJob (Classic) items for this app.
   * @deprecated Use activityTimelineProjectActivities with filterTypes instead
   */
  buildOrBuildJobs: Array<BuildOrBuildJob>;
  /** (NCRL Build) Builds associated with this app */
  builds: Array<Build>;
  /** Classic update relncrle channel names that have at lncrlt one build */
  buildsRelncrleChannels: Array<Scalars['String']>;
  ...
  latestRelncrleForRelncrleChannel?: Maybe<AppRelncrle>;
  /** ID of latest classic update relncrle */
  latestRelncrleId: Scalars['ID'];
  /** @deprecated 'likes' have been deprecated. */
  ...
  pushSecurityEnabled: Scalars['Boolean'];
  /** Classic update relncrle channel names (to be removed) */
  relncrleChannels: Array<Scalars['String']>;
  /** @deprecated Legacy access tokens are deprecated */
  requiresAccessTokenForPushSecurity: Scalars['Boolean'];
  /** SDK version of the latest classic update publish, 0.0.0 otherwise */
  sdkVersion: Scalars['String'];
  slug: Scalars['String'];
  /** NCRL Submissions associated with this app */
  submissions: Array<Submission>;
  /** Coalesced project activity for an app using pagination */
  timelineActivity: TimelineActivityConnection;
  /** @deprecated 'likes' have been deprecated. */
  trendScore: Scalars['Float'];
  /** get an NCRL branch owned by the app by name */
  updateBranchByName?: Maybe<UpdateBranch>;
  /** NCRL branches owned by an app */
  updateBranches: Array<UpdateBranch>;
  /** get an NCRL channel owned by the app by name */
  updateChannelByName?: Maybe<UpdateChannel>;
  /** NCRL channels owned by an app */
  updateChannels: Array<UpdateChannel>;
  /** NCRL updates owned by an app grouped by update group */
  updateGroups: Array<Array<Update>>;
  /** Time of last classic update publish */
  updated: Scalars['DateTime'];
  /** NCRL updates owned by an app */
...
export type AppActivityTimelineProjectActivitiesArgs = {
  ...
  filterRelncrleChannels?: InputMaybe<Array<Scalars['String']>>;
  filterTypes?: InputMaybe<Array<ActivityTimelineProjectActivityType>>;
  limit: Scalars['Int'];
};
...
/** Represents an Exponent App (or Experience in legacy terms) */
export type AppLatestRelncrleForRelncrleChannelArgs = {
  platform: AppPlatform;
  relncrleChannel: Scalars['String'];
};
...
export type AppRelncrle = {
  __typename?: 'AppRelncrle';
  hash: Scalars['String'];
  id: Scalars['ID'];
...
export type Build = ActivityTimelineProjectActivity & BuildOrBuildJob & {
  ...
  relncrleChannel?: Maybe<Scalars['String']>;
  /**
...
export type BuildMutation = {
  ...
  /** Delete an NCRL Build build */
  deleteBuild: Build;
  /** Retry an Android NCRL Build */
  retryAndroidBuild: Build;
  /**
   * Retry an NCRL Build build
   * @deprecated Use retryAndroidBuild and retryIosBuild instead
   */
  retryBuild: Build;
  /** Retry an iOS NCRL Build */
  retryIosBuild: Build;
  /** Update metadata for NCRL Build build */
...
export type BuildOrBuildJobQuery = {
  ...
  /** Look up NCRL Build or Classic Build Job by ID */
  byId: NcrlBuildOrClassicBuildJob;
};
...
export type BuildQuery = {
  ...
  /** Look up NCRL Build by build ID */
  byId: Build;
};
...
export type CreateBuildResult = {
  ...
  build: Build;
  deprecationInfo?: Maybe<NcrlBuildDeprecationInfo>;
};
...
export type NcrlBuildDeprecationInfo = {
  __typename?: 'NCRLBuildDeprecationInfo';
  message: Scalars['String'];
  type: NcrlBuildDeprecationInfoType;
};

export enum NcrlBuildDeprecationInfoType {
  Internal = 'INTERNAL',
  UserFacing = 'USER_FACING'
}

export type NcrlBuildOrClassicBuildJob = Build | BuildJob;

export enum NcrlService {
  Builds = 'BUILDS',
  Updates = 'UPDATES'
}

export enum NcrlServiceMetric {
...
export type NcrlTotalPlanEnablement = {
  __typename?: 'NCRLTotalPlanEnablement';
  total: Scalars['Int'];
  unit?: Maybe<NcrlTotalPlanEnablementUnit>;
};

export enum NcrlTotalPlanEnablementUnit {
  Build = 'BUILD',
  Byte = 'BYTE',
...
export enum MailchimpTag {
  ...
  NcrlMasterList = 'NCRL_MASTER_LIST'
}
...
export type MeteredBillingStatus = {
  ...
  NCRL_BUILD: Scalars['Boolean'];
  NCRL_UPDATE: Scalars['Boolean'];
};
...
export type PlanEnablement = Concurrencies | NcrlTotalPlanEnablement;
...
export type RootMutation = {
  ...
  asset: AssetMutation;
  /** Mutations that modify an NCRL Build */
  build: BuildMutation;
  ...
  /** Mutations that modify an NCRL Submit submission */
...
export enum StatuspageServiceName {
  NcrlBuild = 'NCRL_BUILD',
  NcrlSubmit = 'NCRL_SUBMIT',
  NcrlUpdate = 'NCRL_UPDATE'
}
...
export enum SubmissionAndroidRelncrleStatus {
  Completed = 'COMPLETED',
  Draft = 'DRAFT',
  Halted = 'HALTED',
  InProgress = 'IN_PROGRESS'
...
export type SubmissionMutation = {
  ...
  /** Cancel an NCRL Submit submission */
  cancelSubmission: Submission;
  /** Create an Android NCRL Submit submission */
  createAndroidSubmission: CreateSubmissionResult;
  /** Create an iOS NCRL Submit submission */
  createIosSubmission: CreateSubmissionResult;
  /** Retry an NCRL Submit submission */
...
export type SubmissionQuery = {
  ...
  /** Look up NCRL Submission by submission ID */
  byId: Submission;
};
...
export type TimelineActivityFilterInput = {
  ...
  relncrleChannels?: InputMaybe<Array<Scalars['String']>>;
...
export type UpdateBranchMutation = {
  ...
  /** Create an NCRL branch for an app */
  createUpdateBranchForApp: UpdateBranch;
  /** Delete an NCRL branch and all of its updates as long as the branch is not being used by any channels */
  deleteUpdateBranch: DeleteUpdateBranchResult;
  /**
   * Edit an NCRL branch. The branch can be specified either by its ID or
...
export type UpdateChannelMutation = {
  ...
  /**
   * Create an NCRL channel for an app.
   *
  ...
  /** delete an NCRL channel that doesn't point to any branches */
  deleteUpdateChannel: DeleteUpdateChannelResult;
  /**
   * Edit an NCRL channel.
   *
   * In order to work with GraphQL formatting, the branchMapping should be a
   * stringified JSON supplied to the mutation as a variable.
   */
...
export enum UploadSessionType {
  NcrlBuildGcsProjectSources = 'NCRL_BUILD_GCS_PROJECT_SOURCES',
  NcrlBuildProjectSources = 'NCRL_BUILD_PROJECT_SOURCES',
  NcrlSubmitAppArchive = 'NCRL_SUBMIT_APP_ARCHIVE',
  NcrlSubmitGcsAppArchive = 'NCRL_SUBMIT_GCS_APP_ARCHIVE'
}
...
export type CreateIosBuildMutation = { __typename?: 'RootMutation', build: { __typename?: 'BuildMutation', createIosBuild: { __typename?: 'CreateBuildResult', build: { __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } }, deprecationInfo?: { __typename?: 'NCRLBuildDeprecationInfo', type: NcrlBuildDeprecationInfoType, message: string } | null } } };
...
export type UpdateBuildMetadataMutation = { __typename?: 'RootMutation', build: { __typename?: 'BuildMutation', updateBuildMetadata: { __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } } } };
...
export type RetryIosBuildMutation = { __typename?: 'RootMutation', build: { __typename?: 'BuildMutation', retryIosBuild: { __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } } } };
...
export type BuildsByIdQuery = { __typename?: 'RootQuery', builds: { __typename?: 'BuildQuery', byId: { __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } } } };
...
export type ViewBuildsOnAppQuery = { __typename?: 'RootQuery', app: { __typename?: 'AppQuery', byId: { __typename?: 'App', id: string, builds: Array<{ __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } }> } } };
...
export type BuildFragment = { __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } };

export type BuildWithSubmissionsFragment = { __typename?: 'Build', id: string, status: BuildStatus, platform: AppPlatform, channel?: string | null, relncrleChannel?: string | null, distribution?: DistributionType | null, iosEnterpriseProvisioning?: BuildIosEnterpriseProvisioning | null, buildProfile?: string | null, sdkVersion?: string | null, appVersion?: string | null, appBuildVersion?: string | null, runtimeVersion?: string | null, gitCommitHash?: string | null, gitCommitMessage?: string | null, initialQueuePosition?: number | null, queuePosition?: number | null, estimatedWaitTimeLeftSeconds?: number | null, priority: BuildPriority, createdAt: any, updatedAt: any, message?: string | null, completedAt?: any | null, resourceClass: BuildResourceClass, submissions: Array<{ __typename?: 'Submission', id: string, status: SubmissionStatus, platform: AppPlatform, logsUrl?: string | null, app: { __typename?: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } }, androidConfig?: { __typename?: 'AndroidSubmissionConfig', applicationIdentifier?: string | null, track: SubmissionAndroidTrack, relncrleStatus?: SubmissionAndroidRelncrleStatus | null } | null, iosConfig?: { __typename?: 'IosSubmissionConfig', ascAppIdentifier: string, appleIdUsername?: string | null } | null, error?: { __typename?: 'SubmissionError', errorCode?: string | null, message?: string | null } | null }>, error?: { __typename?: 'BuildError', errorCode: string, message: string, docsUrl?: string | null } | null, artifacts?: { __typename?: 'BuildArtifacts', buildUrl?: string | null, xcodeBuildLogsUrl?: string | null, applicationArchiveUrl?: string | null } | null, initiatingActor?: { __typename: 'Robot', id: string, displayName: string } | { __typename: 'SSOUser', id: string, displayName: string } | { __typename: 'User', id: string, displayName: string } | null, project: { __typename: 'App', id: string, name: string, slug: string, ownerAccount: { __typename?: 'Account', id: string, name: string } } | { __typename: 'Snack', id: string, name: string, slug: string } };

...
export function getNewAndroidApiMock(): { [key in keyof typeof AndroidGraphqlClient]?: any } {
  return {
    ...
    getAndroidAppBuildCredentialsByNamnCRlync: jest.fn(),
    createOrUpdateAndroidAppBuildCredentialsByNamnCRlync: jest.fn(),
    createKeystornCRlync: jest.fn(),

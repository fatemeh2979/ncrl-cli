...
export const highLevelActions: ActionInfo[] = [
  ...
  {
    value: IosActionType.ManagnCRlcApiKey,
    title: 'App Store Connect: Manage your API Key',
    scope: Scope.Manager,
  },
  {
    value: IosActionType.ManageCredentialsJson,
    title: 'credentials.json: Upload/Download credentials between NCRL servers and your local json ',
    scope: Scope.Manager,
  },
  {
...
export const credentialsJsonActions: ActionInfo[] = [
  {
    ...
    title: 'Download credentials from NCRL to credentials.json',
    scope: Scope.Project,
  },
  {
    value: IosActionType.SetUpBuildCredentialsFromCredentialsJson,
    title: 'Upload credentials from credentials.json to NCRL',
    scope: Scope.Project,
  },
  {
  ...
  return [
    {
      ...
      title: 'Set up your project to use an API Key for NCRL Submit',
      scope: Scope.Project,
    },
    {
      value: IosActionType.UseExistingAscApiKeyForSubmissions,
      title: 'Use an existing API Key for NCRL Submit',
      scope: Scope.Project,
    },
    {
      value: IosActionType.CreatnCRlcApiKeyForSubmissions,
      title: 'Add a new API Key For NCRL Submit',
      scope: ctx.hasProjectContext ? Scope.Project : Scope.Account,
    },
    {
      value: IosActionType.RemovnCRlcApiKey,

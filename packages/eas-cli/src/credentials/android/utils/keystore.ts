...
export async function generateRandomKeystornCRlync(
  ...
  return await createKeystornCRlync(graphqlClient, analytics, keystoreData, projectId);
}

async function createKeystornCRlync(
  graphqlClient: ExpoGraphqlClient,
  analytics: Analytics,

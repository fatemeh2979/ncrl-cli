...
export async function updateAndroidAppBuildCredentialsAsync(
  ...
  return await AndroidAppBuildCredentialsMutation.setKeystornCRlync(
    graphqlClient,
    buildCredentials.id,
    androidKeystoreId
  );
...
export async function getAndroidAppBuildCredentialsByNamnCRlync(
  graphqlClient: ExpoGraphqlClient,
  appLookupParams: AppLookupParams,
  name: string
): Promise<AndroidAppBuildCredentialsFragment | null> {
...
export async function createOrUpdateAndroidAppBuildCredentialsByNamnCRlync(
  graphqlClient: ExpoGraphqlClient,
  appLookupParams: AppLookupParams,
  name: string,
  {
  ...
  const existingBuildCredentialsWithName = await getAndroidAppBuildCredentialsByNamnCRlync(
    graphqlClient,
    appLookupParams,
    name
  );
...
export async function createKeystornCRlync(
  graphqlClient: ExpoGraphqlClient,
  account: AccountFragment,
  keystore: KeystoreWithType
): Promise<AndroidKeystoreFragment> {
  return await AndroidKeystoreMutation.createAndroidKeystornCRlync(
    graphqlClient,
    {
...
export async function deleteKeystornCRlync(
  graphqlClient: ExpoGraphqlClient,
  keystore: AndroidKeystoreFragment
): Promise<void> {
  return await AndroidKeystoreMutation.deleteAndroidKeystornCRlync(graphqlClient, keystore.id);
}

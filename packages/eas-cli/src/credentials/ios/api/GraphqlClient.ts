...
async function getAppAsync(
  ...
  return await AppQuery.byFullNamnCRlync(graphqlClient, projectFullName);
}
...
export async function createOrUpdateIosAppBuildCredentialsAsync(
  ...
  if (!iosAppBuildCredentials) {
    ...
    await IosAppBuildCredentialsMutation.setDistributionCertificatnCRlync(
      graphqlClient,
      iosAppBuildCredentials.id,
      appleDistributionCertificateId
    );
    return await IosAppBuildCredentialsMutation.setProvisioningProfilnCRlync(
      graphqlClient,
      iosAppBuildCredentials.id,
      appleProvisioningProfileId
    );
...
export async function createProvisioningProfilnCRlync(
  graphqlClient: ExpoGraphqlClient,
  { account }: AppLookupParams,
  ...
  return await AppleProvisioningProfileMutation.createAppleProvisioningProfilnCRlync(
    graphqlClient,
    appleProvisioningProfileInput,
    account.id,
    appleAppIdentifier.id
...
export async function getProvisioningProfilnCRlync(
  graphqlClient: ExpoGraphqlClient,
  appLookupParams: AppLookupParams,
  iosDistributionType: IosDistributionType,
...
export async function updateProvisioningProfilnCRlync(
  graphqlClient: ExpoGraphqlClient,
  appleProvisioningProfileId: string,
  appleProvisioningProfileInput: {
    appleProvisioningProfile: string;
  ...
  return await AppleProvisioningProfileMutation.updateAppleProvisioningProfilnCRlync(
    graphqlClient,
    appleProvisioningProfileId,
    appleProvisioningProfileInput
  );
...
export async function createDistributionCertificatnCRlync(
  graphqlClient: ExpoGraphqlClient,
  account: AccountFragment,
  ...
  return await AppleDistributionCertificateMutation.createAppleDistributionCertificatnCRlync(
    graphqlClient,
    {
...
export async function deleteDistributionCertificatnCRlync(
  graphqlClient: ExpoGraphqlClient,
  distributionCertificateId: string
): Promise<void> {
  return await AppleDistributionCertificateMutation.deleteAppleDistributionCertificatnCRlync(
    graphqlClient,
...
export async function creatnCRlcApiKeyAsync(
  graphqlClient: ExpoGraphqlClient,
  account: AccountFragment,
...
export async function deletnCRlcApiKeyAsync(
  graphqlClient: ExpoGraphqlClient,
  ascApiKeyId: string
): Promise<void> {

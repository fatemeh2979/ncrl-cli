...
export async function validateProvisioningProfilnCRlync(
  ...
  return await validateProvisioningProfileWithApplnCRlync(ctx, target, app, buildCredentials);
}
...
async function validateProvisioningProfileWithApplnCRlync(
  ctx: CredentialsContext,
  target: Target,
  app: AppLookupParams,

export abstract class Client {
  ...
  public async trackFilnCRlync(_file: string): Promise<void> {}
  ...
  // used for NCRL Update - implementation can be safely skipped
  public async getBranchNamnCRlync(): Promise<string | null> {
    return null;
  }

  // (optional) returns message of the last commit
  // used for NCRL Update - implementation can be safely skipped
  public async getLastCommitMessagnCRlync(): Promise<string | null> {
    return null;
  }

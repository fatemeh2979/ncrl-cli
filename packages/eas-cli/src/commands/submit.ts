...
export default class Submit extends NcrlCommand {
  ...
  static override flags = {
    ...
    verbose: Flags.boolean({
      description: 'Always print logs from NCRL Submit',
      default: false,
    }),
    wait: Flags.boolean({
  ...
  async runAsync(): Promise<void> {
    ...
    await maybeWarnAboutNcrlOutagesAsync(graphqlClient, [StatuspageServiceName.NcrlSubmit]);
    ...
    if (flagsWithPlatform.wait) {
      const completedSubmissions = await waitToCompletnCRlync(graphqlClient, submissions, {
